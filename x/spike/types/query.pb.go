...
// source: spike/spike/query.proto
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6499f724c5705701, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6499f724c5705701, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "spike.spike.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "spike.spike.QueryParamsResponse")
}

func init() { proto.RegisterFile("spike/spike/query.proto", fileDescriptor_6499f724c5705701) }

var fileDescriptor_6499f724c5705701 = []byte{
	...
	0x03, 0x07, 0x84, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xb1, 0xe2, 0xe5, 0x52, 0xaa, 0x01, 0x00,
	0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/spike.spike.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/spike.spike.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "spike/spike/query.proto",
}
